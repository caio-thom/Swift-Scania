...
class SiteCarrViewController: UIViewController {

    @IBOutlet weak var sobreWebView : WKWebView!
    override func viewDidLoad() {
        super.viewDidLoad()
        
        let url: URL? = URL(string: "https://www.scania.com/br/pt/home/about-scania/career.html")
